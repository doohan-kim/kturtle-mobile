        ...
        for _, meta in part.iterrows():
            ...
            try:
                ...
                results.append({
                    ...
                    "H20": round(sig["h20"], 2),
                    "H55": round(sig["h55"], 2),
                    "TodayHigh": round(sig["high"], 2),
                    "TodayVolume": int(sig["today_volume"]),
                    "Avg20Volume": round(sig["avg20_volume"], 2),
                    "VolumeRatio": round(sig["volume_ratio"], 2),
                    "Break20Pct": round(sig["breakout20_pct"], 2) if sig["breakout20_pct"] is not None else None,
                    "Break55Pct": round(sig["breakout55_pct"], 2) if sig["breakout55_pct"] is not None else None,
