...
with tab1:
    ...
    if "kt_candidates" in st.session_state:
        ...
        if cand.empty:
            ...
            st.caption("가격 Gate 후보를 섹터별로 압축했습니다. RS는 돌파 후보끼리가 아니라 해당 섹터 전체 종목을 기준으로 계산합니다.")
...
st.caption("v1.9 최종 흐름: 섹터 전체 RS 대장주 → Heat → 재무 Gate → 삼성증권 주문 준비")
